...
\begin{document}
    \begin{tikzpicture}[font=\sffamily]
      \node[label={$\frac12$}] (A) at (0,0) {$A$}; 
      \node[label={$\frac12$}] (B) at (2,0) {$B$}; 
      \node[label={$\frac12$}] (C) at (4,0) {$C$}; 
      \node[label={$\frac12$}] (D) at (6,0) {$D$}; 
      \node[draw=none] (a) at (-1,-1) {$0$};
      \node[draw=none] (b) at (1,-1) {$\frac12$};
      \node[draw=none] (c) at (5,-1) {$\frac12$};
